...
export const metadata: Metadata = {
  ...
  description:
    "Пластиковые окна с установкой в Луганске и ЛНР! Качественно и недорого. Остекление балконов, продажа и установка дверей, жалюзи и рулонных штор. Гарантия и индивидуальный подход!",
  keywords:
    "пластиковые окна, окна пвх, установка, ремонт окон, остекление балконов, входные межкомнатные двери, жалюзи, рулонные шторы",
};
